<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
    ...
    <div class="sidenav-header">
        ...
        <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="{{ route('dashboard') }}">
            <span class="ms-3 font-weight-bold">Audit Informatique</span>
        </a>
    </div>
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item pb-2">
                <a class="nav-link {{ Request::is('question') ? 'active' : '' }}" href="{{ url('question') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i style="font-size: 1rem;"
                            class="fas fa-lg fa-list-ul ps-2 pe-2 text-center text-dark {{ Request::is('question') ? 'text-white' : 'text-dark' }} "
                            aria-hidden="true"></i>
                    </div>
            ...
            <li class="nav-item pb-2">
                <a class="nav-link {{ Request::is('courier') ? 'active' : '' }}" href="{{ url('courier') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i style="font-size: 1rem;"
                            class="fas fa-lg fa-list-ul ps-2 pe-2 text-center text-dark {{ Request::is('courier') ? 'text-white' : 'text-dark' }} "
                            aria-hidden="true"></i>
                    </div>
            ...
            <li class="nav-item pb-2">
                <a class="nav-link {{ Request::is('audit') ? 'active' : '' }}" href="{{ url('audit') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i style="font-size: 1rem;"
                            class="fas fa-lg fa-list-ul ps-2 pe-2 text-center text-dark {{ Request::is('audit') ? 'text-white' : 'text-dark' }} "
                            aria-hidden="true"></i>
                    </div>
            ...
            @if (isset($user_departments))
                @foreach ($user_departments as $user_department)
                    <li class="nav-item pb-2">
                        <a class="nav-link {{ Request::is('departmentView') ? 'active' : '' }}"
                            href='{{ url("departmentView?id=$user_department->id") }}'>
                            <div
                                class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                                <i style="font-size: 1rem;"
                                    class="fas fa-lg fa-list-ul ps-2 pe-2 text-center text-dark {{ Request::is('departmentView') ? 'text-white' : 'text-dark' }} "
                                    aria-hidden="true"></i>
                            </div>
