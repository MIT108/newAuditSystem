...
@section('content')
    <div>
        ...
        <div class="tab-content">
            ...
            <div id="document" class="tab-pane fade  my-4">
                <div class="row">
                    <div class="col-12">
                                                ...
                                                <tr>
                                                    <td class="ps-4">
                                                        ...
                                                        <input type="text" name="question_id" value="{{ $question->id }}"
                                                            required hidden>
                                                        <input type="text" name="department_id" value="1" required hidden>
                                                    </td>
                                                        ...
                                                        <div class="progress-wrapper w-75 mx-auto">
                                                            <div class="progress-info">
                                                                <div class="progress-percentage">
                                                                    <span class="text-xs font-weight-bold">{{ $question->percent }}%</span>
                                                                </div>
                                                            </div>
                                                            <div class="progress">
                                                                <div class="progress">
                                                                    <div class="progress-bar bg-{{ $question->type }} w-{{ $question->percent }} " role="progressbar"
